...
- **能力边界**：原流程虽然也是 1 人操作，但产出物不完整，单人通常只能覆盖某一个职能（如前端只写代码、PM 只写文档），跨职能的「PM 写 PRD + 前端画原型 + QA 跑测试」必须多人协作才能完成；Agent 工作流下，**1 人即可同时承担 PM、前端、QA 三个角色的产出**，跨职能沟通次数由 N 次降为 0 次。
...
| **人力成本**   | 单人只能产出「静态原型」或「纯文本 PRD」二选一，跨职能需 PM + 前端 + QA 多人协作 | 1 人可同时承担 PM + 前端 + QA 三角色产出，跨职能沟通次数 N → 0 | 产出物覆盖原型 + PRD + 截图 + Git 提交 |
